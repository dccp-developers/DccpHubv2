...
<template>
  <div>
    ...
    <div class="fixed top-0 left-0 right-0 h-14 border-b bg-background z-50 md:hidden flex items-center justify-between px-4">
    ...
    <div class="fixed bottom-0 left-0 right-0 border-t bg-background z-50 md:hidden">
