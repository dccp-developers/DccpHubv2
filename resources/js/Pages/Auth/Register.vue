    ...
    <AuthBase title="Create an account" description="Enter your details below to create your account">
        ...
        <form @submit.prevent="step === 4 ? submit() : nextStep()" class="flex flex-col gap-6">
            ...
            <div v-if="step === 2" class="flex flex-col">
                ...
                <Input id="email" type="email" required v-model="emailForm.email" placeholder="email@example.com"
                    class="mt-2" />
            ...
            <div v-if="step === 4" class="flex flex-col">
                ...
                <Input id="name" type="text" required v-model="finalForm.name" placeholder="Your full name"
                    class="mt-2" />
            ...
            <div v-if="step === 4" class="flex flex-col">
                ...
                <div class="relative mt-2">
                    <Input id="password" :type="showPassword ? 'text' : 'password'" required
                        v-model="finalForm.password" placeholder="Password" class="pr-10" />
            ...
            <div v-if="step === 4" class="flex flex-col">
                ...
                <div class="relative mt-2">
                    <Input id="password_confirmation" :type="showPasswordConfirmation ? 'text' : 'password'" required
                        v-model="finalForm.password_confirmation" placeholder="Confirm Password" class="pr-10" />
            ...
            <Button type="submit" class="mt-4 w-full" :disabled="emailForm.processing || idForm.processing || finalForm.processing
                ">
                <LoaderCircle v-if="
                    emailForm.processing || idForm.processing || finalForm.processing
